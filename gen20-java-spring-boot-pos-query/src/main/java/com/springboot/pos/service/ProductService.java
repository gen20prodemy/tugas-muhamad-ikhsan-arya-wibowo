...
public class ProductService {
    ...
    public Optional<Product> getProductByIdNative(Long id) throws IllegalAccessException {
        boolean exist = productRepository.existsById(id);
        if (!exist){
            throw new IllegalAccessException("product by id " + id + " does not exist");
        }
    ...
    public Optional<Product> getProductByCategoryJPQL(Integer category){
        return productRepository.findProductByCategoryJPQL(category);
    }
}
